...
const services = ref([
  {
    ...
    description:
      'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis earum, tempore doloribus molestias officia corrupti sit reiciendis soluta aliquid veritatis.',
  },
  {
    id: 2,
